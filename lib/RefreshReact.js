...
function (_Component) {
  ...
  function RefreshReact() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "onRefresh", function (cb) {
      return _this.props.onRefresh(cb);
    });
